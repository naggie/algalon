...
var Main = function() {
	...
	this.instantiateEntity = function(initial) {
		...
		console.assert(initial.entity,'Entity State: entity must be defined')
		console.assert(initial.entity.match(/[A-Z][a-z]+/),'Entity State: class name invalid')
		...
		var Class = require('./entities/'+initial.entity)
