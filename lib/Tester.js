...
var State = function(initial) {
	...
	this.fail = function(err) {
		...
		else if (consecutive_failures == self.fail_threshold && self.lastpassedge)
	...
	this.pass = function() {
		...
		else if (consecutive_passes == self.pass_threshold && self.lastfailedge)
	...
	var pushEvent = function() {
		...
		e = {
			...
			class : snapshot.healthy? 'pass':'fail',
			tester_id : self.id,
		}
		self.emit('event',e)
	}
